...
#2 lista de palabras que aparecen en la primera list, pero no en la segunda
...
print(f"lista de palabras que aparecen en la primera list, pero no en la segunda: {solo1}")
